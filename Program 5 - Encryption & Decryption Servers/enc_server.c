...
Specifics:      This is the encoding server, that recieves unencrypted information and encrypts and sends it back to client
*/
                ...
                while(cont == 1){
                    ...
                    // Checking if all of the packet has been sent by looking for the "@" character
                        ...
                        if (keybit == 0){
                            ...
                            encryption(p_packet, k_packet, e_packet);
                            secure_packet_send(connectionSocket, e_packet, buffer);
                        }
                    } 
